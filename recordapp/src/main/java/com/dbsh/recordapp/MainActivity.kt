...
import com.dbsh.recordapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), OnTimerTickListener {
    ...
    private fun startRecording() {
        ...
        recorder = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            ...
            try {
                ...
                Log.e("APP", "MediaRecorder prepare fail $e")
            }
        ...
        binding.recordButton.setImageDrawable(ContextCompat.getDrawable(this,
    ...
    private fun stopRecording() {
        ...
        state = State.RELEASE
        binding.recordButton.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.ic_baseline_fiber_manual_record_24))
    ...
    private fun startPlaying() {
        ...
        player = MediaPlayer().apply {
            try {
                ...
                Log.e("APP", "MediaPlayer prepare fail $e")
            }
            start()
        }
